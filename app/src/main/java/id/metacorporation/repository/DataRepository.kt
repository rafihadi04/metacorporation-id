...
class DataRepository{
    ...
    init {
        ...
        programAPI.getProgramUrl(API_KEY).enqueue(object:Callback<ArrayList<ProgramLink>>{
            ...
            override fun onResponse(
                ...
                response: Response<ArrayList<ProgramLink>>
            ) {
                programURL = response.body()
                Log.d("GET PROGRAM",programURL.toString())
            }

            override fun onFailure(call: Call<ArrayList<ProgramLink>>, t: Throwable) {
                programURL = null
            }
        })
    }
    ...
    fun pullCredits() {
        programAPI.getCreditTitle(API_KEY).enqueue(object : Callback<ArrayList<CreditModel>> {
            override fun onResponse(
                ...
                Log.d("GET CREDIT", credits.toString())
            }

            override fun onFailure(call: Call<ArrayList<CreditModel>>, t: Throwable) {
                //credits = null
            }
            ...
            dataTV.addAll(
                arrayListOf(
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara= arrayListOf(
                            JobdeskModel(
                                "Guest Star",
                                namaKru = "Coldiac",
                                resourceImage = R.drawable.superbloom_coldiac2_150px
                            ),
                        ),
                    ...
                    ProgramModel(
                        ...
                        resourceBanner = R.drawable.metamore_movie_landscape,
                    ...
                    ProgramModel(
                        ...
                        jadwal = "Rabu, 17 Nov 2021 Pukul 14.15 WIB",
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                "Host",
                                namaKru = "Agung Al-Farhan",
                                resourceImage = R.drawable.galleria_host_agung_150px
                            ),
                            JobdeskModel(
                                "Co-Host",
                                namaKru = "Rois Alifa",
                                resourceImage = R.drawable.galleria_cohost_rois_150px
                            ),
                            JobdeskModel(
                                "Guest Star",
                                namaKru = "Olski",
                                resourceImage = R.drawable.galleria_gueststar_olski1_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
                    ...
                    ProgramModel(
                        ...
                        resourceBanner = R.drawable.ruang_rasa_landscape,
                        //urlBannerImage = "https://images.pexels.com/photos/7078048/pexels-photo-7078048.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260",
                        //urlTeaser = "pOWuBM2RNmI",
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                "Presenter",
                                namaKru = "Anggria Ratri",
                                resourceImage = R.drawable.lensabulletin_anggria2_150px
                            ),
                            JobdeskModel(
                                "Presenter",
                                namaKru = "Dika Pradana",
                                resourceImage = R.drawable.lensabulletin_dika2_150px
                            ),
                            JobdeskModel(
                                "Presenter",
                                namaKru = "Yohanifa Ersha",
                                resourceImage = R.drawable.lensabulletin_yohanifa2_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                "Presenter",
                                namaKru = "Shahnaz Dinda",
                                resourceImage = R.drawable.labiran_presenter_shahnaz_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                ...
                                resourceImage = R.drawable.icon_presenter3_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                ...
                                resourceImage = R.drawable.metanewsjournal_presenter_insan_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
    ...
    fun getProgramRadio() :ArrayList<ProgramModel>{
                ...
                arrayListOf(
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                "Announcer",
                                namaKru = "Zharifah Salma Hutami",
                                resourceImage = R.drawable.media_announcer_zharifah_150px
                            ),
                            JobdeskModel(
                                "Narasumber",
                                namaKru = "Judith Gracia Adha",
                                resourceImage = R.drawable.media_narsum_judith_150px
                            ),
                            JobdeskModel(
                                "Narasumber",
                                namaKru = "Salma Dias Saraswati",
                                resourceImage = R.drawable.media_narsum_salma_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                "Announcer",
                                namaKru = "Atya Kirana",
                                resourceImage = R.drawable.metup_announcer_atya_150px
                            ),
                            JobdeskModel(
                                "Guest Star",
                                namaKru = "Satisfaith",
                                resourceImage = R.drawable.metup_gueststar_satisfaith1_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                "Announcer",
                                namaKru = "Nicky Shaquilla",
                                resourceImage = R.drawable.soulmet_announcer_nicky1_150px
                            ),
                            JobdeskModel(
                                "Announcer",
                                namaKru = "Ubay Reza",
                                resourceImage = R.drawable.soulmet_announcer_ubay2_150px
                            ),
                            JobdeskModel(
                                "Guest Star",
                                namaKru = "Round Weasley",
                                resourceImage = R.drawable.soulmet_bintangtamu_rondweasley2_150px
                            ),
                            JobdeskModel(
                                "Home Band",
                                namaKru = "Ginanjar Bimantoro",
                                resourceImage = R.drawable.soulmet_pengiring_ginanjar_150px
                            ),
                            JobdeskModel(
                                "Home Band",
                                namaKru = "Vincentius",
                                resourceImage = R.drawable.soulmet_pengiring_vincentius_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                "Announcer",
                                namaKru = "Fiorentina Indhi Mentari",
                                resourceImage = R.drawable.madammeta_announcer_fiorentina_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                "Announcer",
                                namaKru = "Rahma Fauziah",
                                resourceImage = R.drawable.bias_presenter_rahmafauziah_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
                    ...
                    ProgramModel(
                        ...
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                "Announcer",
                                namaKru = "Ida Setya",
                                resourceImage = R.drawable.sorotfakta_presenter_ida_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
                    ...
                    ProgramModel(
                        ...
                        resourceBanner = R.drawable.asumsi___landscape_copy,
                        //urlBannerImage = "https://images.pexels.com/photos/7078048/pexels-photo-7078048.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260",
                        //urlTeaser = "pOWuBM2RNmI",
                        ...
                        fotoPembawaAcara = R.drawable.asumsi___landscape_polos_copy,
                        detilPembawaAcara="Coldilac adalah bla bla bla?????",
                        pengisiAcara = arrayListOf(
                            JobdeskModel(
                                "Announcer",
                                namaKru = "Dian Hastuti",
                                resourceImage = R.drawable.asumsi_presenter_dianhastuti_150px
                            ),
                            JobdeskModel(
                                "Pimpinan Redaksi",
                                namaKru = "Septian Yusuf",
                                resourceImage = R.drawable.asumsi_presenter_yusuf_150px
                            ),
                        ),
                        kruJobdesk = arrayListOf(
                            //CONTOH DATA JOBDESK
        ...
        return injectData(dataRadio)
    }

    private fun injectData(data :ArrayList<ProgramModel>): ArrayList<ProgramModel> {
        data.forEach {
            it.urlTeaser = programURL?.firstOrNull { program ->
                (it.namaProgram.lowercase().contains(program.program!!))
            }?.linkYT?.split("https://www.youtube.com/watch?v=")?.last()
            Log.d("inject Data URL" , "${it.namaProgram}:\t${it.urlTeaser?:"null"}")
        }
        return data
    }
    ...
    fun getTopProgram(tipe : TopProgramType) :ArrayList<ProgramModel>{
         ...
         * */
        val topRadio = listOf(0,1,2,3,4)
        val topTV = listOf(0,1,2,3,4)
    ...
    private fun linkTVSchedule() :String {
        ...
        //Log.d("LINKTV", ((GregorianCalendar( 2021,10,11).time.time-now)).toString())
        return when {
            isSameDay(GregorianCalendar(2021, 10, 11)) -> "_6v7WFVmtQU"
            isSameDay(GregorianCalendar(2021, 10, 12)) -> "SID0c6As8Xs"
            isSameDay(GregorianCalendar(2021, 10, 10)) -> "VHXKbf95EnY"
            isSameDay(GregorianCalendar(2021, 10, 17)) -> "2MQrjapb6E0"
            isSameDay(GregorianCalendar(2021, 10, 18)) -> "WafX-5p-z6g"
            else -> "o7kFCNLU8RQ"
        }
    }
    ...
    private fun linkRadioSchedule() :String {
        ...
        //Log.d("LINKTV", ((GregorianCalendar( 2021,10,11).time.time-now)).toString())
        return when {
            isSameDay(GregorianCalendar(2021, 10, 11)) -> "RH1LyAKHn8M"
            isSameDay(GregorianCalendar(2021, 10, 12)) -> "mQPD_mbVL2k"
            isSameDay(GregorianCalendar(2021, 10, 10)) -> "hNAbQYU0wpg"
            isSameDay(GregorianCalendar(2021, 10, 15)) -> "wA_ENQpwZE4"
            isSameDay(GregorianCalendar(2021, 10, 16)) -> "eM4vGmvKB38"
            else -> "o7kFCNLU8RQ"
        }
    }

    private fun isSameDay(a:GregorianCalendar):Boolean{
        val oneDay = (24*60*60*1000)
        val aConvert = a.time.time
        val b = a.time.time + oneDay
        val now = Date().time
        return (aConvert-now < 0) and (b-now < oneDay)
    }
}